...
export const MODEL_REGISTRY: readonly ModelEntry[] = [
  ...
  // now pins `@anthropic-ai/claude-agent-sdk` 0.3.270 exactly, whose bundled
  // `claude-agent-sdk-linux-x64@0.3.270` carries VERSION 2.1.270 ≥ 2.1.251
